            ...
            commands: [
                {
                    ...
                    schema: {
                        ...
                        'цена': { description: 'обязательно, ключевое слово "р", "руб", "рублей" является ключом к поиску цены в сообщении' },
                        'количество': { description: 'не обязательно, в случае отсутствия = 1, ключ - "шт", "штук"' },
